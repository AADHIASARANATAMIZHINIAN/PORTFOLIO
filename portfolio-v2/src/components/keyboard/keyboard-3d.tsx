  ...
  return (
    <group position={[0, -1, 0]} rotation={[0.1, 0, 0]}>
      ...
      <mesh position={[0, -0.5, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#0f0f14" roughness={0.2} metalness={0.8} />
      </mesh>
          ...
          return (
            <group key={rowIndex} position={[0, 0, rowIndex * 1.1]}>
              {row.map((keyData) => {
                ...
                const isPressed =
                  activeKeys.has(keyData.code) || (keyData.code === 'CapsLock' && capsLock)
                ...
                return (
                  <Key
                    ...
                    onPress={() => {
                      ...
                      const down = new KeyboardEvent('keydown', { key: keyVal, code: keyData.code })
                      window.dispatchEvent(down)
                      setTimeout(() => {
                        const up = new KeyboardEvent('keyup', { key: keyVal, code: keyData.code })
